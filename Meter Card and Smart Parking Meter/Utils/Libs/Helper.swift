...
class Helper {
    ...
    // if fromDate1 is after or equal to fromDate2 and toDate1 is before or equal to toDate2 ==> true else false
    ...
    // if fromTime1 is after or equal to fromTime2 and toTime1 is before or equal to toTime2 ==> true else false
